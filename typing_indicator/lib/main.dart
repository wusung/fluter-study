...
class ExampleIsTyping extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => ExampleIsTypingState();
}

class ExampleIsTypingState extends State<ExampleIsTyping> {
...
class TypingIndicator extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => TypingIndicatorState();
}
...
class TypingIndicatorState extends State<TypingIndicator>
  ...
  final List<Interval> _doIntervals = const [
    Interval(0.25, 0.8),
    Interval(0.35, 0.9),
    Interval(0.45, 1.0),
  ];
...
class FlashingCycle extends StatelessWidget {
  final int index;
  final AnimationController repeatingController;
  final List<Interval> dotIntervals;
  final Color flashingCircleBrightColor;
